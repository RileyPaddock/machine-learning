...
print("\nTesting Inverse for wrong size Matrix:")
assert (a_has_inverse.inverse()).round(6).elements == (b_has_inverse.inverse()).round(6).elements,'Incorrect Inverse for wrong size'
print("Passed")
print("\nTesting Inverse for 3x3 Matrix:")
assert (a_has_inverse.inverse()).round(6).elements == (b_has_inverse.inverse()).round(6).elements,'Incorrect Inverse for invertible 3x3'
print("Passed")
...
assert (large_matrix @ large_matrix.inverse()).round(6).elements == four_by_four_identity.elements,'Incorrect Inverse for large_matrix'
print("Passed")

print("\nTesting Inverse for 5x5 Matrix:")
assert (larger_matrix @ larger_matrix.inverse()).round(6).elements == five_by_five_identity.elements,'Incorrect Inverse for large_matrix'
print("Passed")

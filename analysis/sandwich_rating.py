...
#   0 * beta_0 + 0 * beta_1 + 0 * beta_2 = 1
#   00 * beta_0 + 1 * beta_1 + 0 * beta_2 = 2
#   00 * beta_0 + 2 * beta_1 + 0 * beta_2 = 4
#   00 * beta_0 + 4 * beta_1 + 0 * beta_2 = 8
#   00 * beta_0 + 6 * beta_1 + 0 * beta_2 = 9
#   00 * beta_0 + 0 * beta_1 + 2 * beta_2 = 2
#   00 * beta_0 + 0 * beta_1 + 4 * beta_2 = 5
#   00 * beta_0 + 0 * beta_1 + 6 * beta_2 = 7
#   00 * beta_0 + 0 * beta_1 + 8 * beta_2 = 6
...
sandwich_data  = Matrix(elements = [[0,0,0],[0,1,0],[0,2,0],[0,4,0],[0,6,0],[0,0,2],[0,0,4],[0,0,6],[0,0,8]])
